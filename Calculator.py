def calculator(tal1, tecken, tal2, shouldPrint=False, shouldAsk=False):
    ...
    if tecken == "+" or tecken.lower() == "addition":
        summa = tal1 + tal2
        if shouldPrint:
            print(summa)
        return summa
    elif tecken == "-" or tecken.lower() == "subtraction":
        differens = tal1 - tal2
        if shouldPrint:
            print(differens)
        return differens
    elif tecken == "*" or tecken.lower() == "multiplication":
        produkt = tal1 * tal2
        if shouldPrint:
            print(produkt)
        return produkt
    elif tecken == "/" or tecken.lower() == "division":
        kvot = tal1 / tal2
        if shouldPrint:
            print(kvot)
        return kvot
    elif tecken == "**" or tecken.lower() == "power":
        potens = tal1 ** tal2
        if shouldPrint:
            print(potens)
        return potens
